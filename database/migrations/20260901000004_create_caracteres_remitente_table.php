...
final class CreateCaracteresRemitenteTable extends AbstractMigration
{
    public function change(): void
    {
        $table = $this->table('caracteres_remitente', ['id' => false, 'primary_key' => ['id'], 'signed' => false]);
        $table->addColumn('id', 'integer', ['identity' => true, 'signed' => false])
              ...
              ->addIndex(['nombre'], ['unique' => true, 'name' => 'uq_caracteres_remitente_nombre'])
              ->create();
    }
}
