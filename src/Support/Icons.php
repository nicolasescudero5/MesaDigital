...
{
    /**
     * Retorna el SVG inline limpio con atributos XML estrictos (fill="none" stroke="currentColor")
     * garantizando que nunca se rendericen círculos negros o rellenos no deseados.
     */
    public static function render(string $name, string $class = 'w-4 h-4'): string
    {
        $svgs = [
            ...
            'file-spreadsheet' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>',
        ...
        $content = $svgs[$name] ?? '<circle cx="12" cy="12" r="9"/>';

        return sprintf(
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="%s inline-block shrink-0" aria-hidden="true">%s</svg>',
